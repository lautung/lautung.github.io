...
2. 学习 UI：先看 [高级 UI 导读](./advanced-ui/overview.md)，再进入独立的 [Compose 入门](../compose/getting-started.md) 专题。
...
Jetpack Compose 已作为一级专题维护，适合在理解 Activity、资源和生命周期之后学习。Android 专题会保留传统 View、Jetpack 组件、架构和平台能力；Compose 专题专注声明式 UI 写法。
