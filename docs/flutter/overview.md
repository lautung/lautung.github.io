...
| 状态与导航 | 处理页面状态、Provider/Riverpod 共享状态、页面跳转和参数传递。 |
...
4. 学习 [Widget 与布局](./widgets-layout.md)、[状态管理入门](./state.md)、[Provider 状态管理](./provider.md)、[Riverpod 状态管理](./riverpod.md) 和 [页面导航](./navigation.md)。
